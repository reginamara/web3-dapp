          ...
          <>
            ...
            <div className="row flex-lg-row-reverse align-items-center g-5">
                <div className="col-7">
                    {
                        ...
                        : <img src={campaign.imageUrl} className="d-block mx-lg-auto img-fluid" width="640" height="480" alt="Imagem da Campanha"/>
                    }
                </div>
                <div className="col-5 mb-5" style={{height : 480, scrollbars: true}}>
                    ...
                    <p className="mb-3 fst-italic mt-5">E aí, o que achoi do projeto? Já foi arrecado {campaign.balance / 10 ** 18} BNB nesta campanha. O quanto você quer doar (em BNB)?</p>
                    <div className="mb-3">
