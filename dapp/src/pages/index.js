      ...
      <div className="container px-4 py-5">
        <div className="row flex-lg-row-reverse align-items-center py-5 g-5">
          {!wallet ? (
            <div className="col-10 col-sm-8 col-lg-6">
              <img
                ...
                width="700"
                height="500"
                src="https://images.unsplash.com/photo-1591035897819-f4bdf739f446?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
                alt=""
              />
            </div>
          ) : (
            <div className="col-10 col-sm col-lg-6">
          ...
          <div className="col-lg-6">
            ...
            <p className="lead">Sua plataforma descentalizada de doações.</p>
